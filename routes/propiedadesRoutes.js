...
router.post('/propiedades/crear',
    ...
    body('descripcion').notEmpty().withMessage('La descripcion del anuncio es obligatorio'),
    ...
    body('estacionamiento').isNumeric().withMessage('Selecciona una cantidad de estacionamiento'),
...
router.post('/propiedad/:id',
    identificarUsuario,
    body('mensaje').isLength({min:10}).withMessage('El mensaje no puede tener menos de 10 caracteres'),
    enviarMensaje)
